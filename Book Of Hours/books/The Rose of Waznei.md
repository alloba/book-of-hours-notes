...
aspects: 
  ...
  - name: "mystery: lantern"
    amount : 8
  - name: "subject: aural contemplations"
    amount : 1
...
Seek in dreams; seek [[World/The Mansus|the Mansus]]. The Third Mark can be achieved only when one has passed [[The Stag Door]]. One must pass the Wood. One must rise to [[The White Door]]. The Stag Door awaits the light-bearer, in the sight of Ghirbi.'